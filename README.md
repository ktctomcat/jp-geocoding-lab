...
[gc_class](https://github.com/ktctomcat/jp-geocoding-lab/tree/main/gc_class)の中のファイルは調べたい住所等から緯度・経度と住所だけを抜き出してリストとして得るためのクラスで、geocoding.pyからインポートして使う仕組みになっています。  
